...
public class BackExercises extends AppCompatActivity implements RecyclerViewInterface{
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    if(exercise.getMuscleGroupName().equals("Back")){
                        list.add(exercise);
                    }
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(BackExercises.this, DescExercise.class);
